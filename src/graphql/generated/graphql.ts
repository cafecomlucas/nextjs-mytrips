...
export type GetPlacesQuery = { __typename?: 'Query', places: Array<{ __typename?: 'Place', id: string, name: string, slug: string, location: { __typename?: 'Location', latitude: number, longitude: number } }> };
...
export type GetPlaceBySlugQuery = { __typename?: 'Query', place?: { __typename?: 'Place', name: string, description?: { __typename?: 'RichText', html: string, text: string } | null, gallery: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> } | null };
